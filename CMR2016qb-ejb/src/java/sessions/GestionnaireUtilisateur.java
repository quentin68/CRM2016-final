...
public class GestionnaireUtilisateur {
     ...
     * @return
     */
    public Utilisateur add(String nom, String prenom, String pseudo, String password, String mail, String telephone, boolean estAdmin) {
        Utilisateur u = new Utilisateur(nom, prenom, pseudo, password, mail, telephone, estAdmin);
        em.persist(u);
        return u;
    }
    ...
    /**
     * Verifie si le login et le mot de passe correspondent a un compte parmi les utilisateurs enregistres
     * @param login
     * @param password
     * @return
     */
    ...
    public void set(int id, String nom, String prenom, String pseudo, String password, String mail, String telephone, boolean estAdmin) {
      ...
      public void creerAdmin() {
        ...
        Utilisateur u = new Utilisateur("Bauer", "Quentin", "quentin68", "123456","qbauer68@gmail.com", "0610936472", true);
        create(u);
    }
